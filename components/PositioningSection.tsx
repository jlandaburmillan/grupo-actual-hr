    ...
    <section className="section-pad bg-deep-navy text-white">
      <div className="section-shell grid gap-10 lg:grid-cols-[0.9fr_1fr] lg:items-center">
        <div>
          ...
          <p className="mt-6 rounded-xl border border-electric-cyan/30 bg-white/10 p-5 text-base font-black leading-7 text-white">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {blocks.map((block) => (
            <article key={block} className="rounded-xl border border-white/10 bg-white/10 p-6 shadow-[0_20px_60px_rgba(0,0,0,0.14)] transition hover:-translate-y-1 hover:border-electric-cyan/50">
