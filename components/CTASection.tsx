      ...
      <div className="section-shell grid gap-10 lg:grid-cols-[1fr_0.78fr] lg:items-center">
        <div>
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <a href="/contacto?interes=Discovery%20funcional#contacto" className="focus-ring inline-flex items-center justify-center gap-2 rounded-lg bg-sap-blue px-5 py-3 text-sm font-black text-white transition hover:-translate-y-0.5 hover:bg-white hover:text-deep-navy">
              Solicitar diagnóstico de procesos HR <ArrowRight size={18} aria-hidden />
            </a>
            <a href="#blueprint" className="focus-ring inline-flex items-center justify-center rounded-lg border border-white/20 px-5 py-3 text-sm font-black text-white transition hover:-translate-y-0.5 hover:bg-white/10">
