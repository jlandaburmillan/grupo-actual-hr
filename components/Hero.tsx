...
export function Hero() {
  return (
    <section id="inicio" className="relative overflow-hidden bg-deep-navy pt-[calc(var(--header-height)+5rem)] text-white">
      <div className="absolute inset-0 dark-blueprint-grid opacity-55" aria-hidden="true" />
      <div className="section-shell relative grid min-h-[680px] items-center gap-10 pb-16 sm:pb-20 lg:grid-cols-[1fr_0.92fr] lg:pb-24">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-white/78 md:text-xl md:leading-9">
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            ...
            <a
              href="#metodologia"
              className="focus-ring inline-flex items-center justify-center rounded-lg border border-white/18 px-5 py-3 text-sm font-black text-white transition hover:-translate-y-0.5 hover:border-white hover:bg-white/10"
            >
        ...
        <div className="relative">
          <div className="premium-card relative rounded-[1.5rem] border-white/20 bg-white/96 p-4 text-graphite-blue shadow-soft">
            <div className="blueprint-panel rounded-[1.25rem] p-5 text-white">
              <div className="flex items-center justify-between gap-4 border-b border-white/12 pb-5">
                ...
                <span className="rounded-lg border border-electric-cyan/35 px-3 py-2 text-center text-xs font-black text-electric-cyan">
                  BPML
                  <span className="mt-1 block text-[0.62rem] font-bold normal-case tracking-normal text-white/62">(Maestro de Procesos)</span>
                </span>
              </div>

              <div className="relative mt-8 rounded-xl border border-white/12 bg-white/8 p-5">
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-4">
                {layers.map((layer) => (
                  <div key={layer} className="rounded-xl border border-white/12 bg-white/10 p-4">
              ...
              <div className="mt-5 grid gap-3">
                {portlets.map((portlet) => (
                  <div key={portlet.title} className="rounded-xl border border-white/12 bg-white p-4 text-deep-navy">
